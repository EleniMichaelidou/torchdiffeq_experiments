...
file_labels = [
    ('mnist_odenet_False.xlsx', 'RK-Net'),
    ('mnist_odenet_True.xlsx', 'ODE-Net'),
    ('mnist_resnet_False.xlsx', 'ResNet')
]  # Replace with your actual file paths and labels

# List of percentage values
percentage_values = [0.01, 0.05, 0.1, 0.15, 0.20, 0.25, 0.5, 0.75, 1.0]
...
for percentage in percentage_values:
    ...
    plot_filename = os.path.join('plots', f'mnist_plot_percentage_{percentage}.png')
